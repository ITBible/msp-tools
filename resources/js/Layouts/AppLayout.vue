...
const navigation = [
    ...
    { name: 'Pastes', href: route('admin.pastes.index'), icon: ClipboardIcon, current: route().current('admin.pastes.*') },
]
...
<template>
    <Head :title="props.title ? props.title : 'Home'" />
                        ...
                        <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
                            ...
                            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                                <div class="flex h-16 shrink-0 items-center">
                                    <img class="h-8 w-auto" :src="$page.props.config.app_logo" alt="MSP-TOOLS" />
                                </div>
...
<!--                        <div class="hidden lg:block lg:h-6 lg:w-px lg:bg-gray-900/10" aria-hidden="true" />-->
                        ...
                        <Menu as="div" class="relative">
                            <MenuButton class="-m-1.5 flex items-center p-1.5">
                                ...
                                <img class="h-8 w-8 rounded-full bg-gray-50" :src="$page.props.auth.user.profile_photo_url" :alt="$page.props.auth.user.name" />
